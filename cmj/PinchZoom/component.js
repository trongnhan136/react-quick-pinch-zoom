...
var PinchZoom = /** @class */ (function (_super) {
    ...
    function PinchZoom() {
        ...
        // @ts-ignore
        _this._containerRef = (0, react_1.createRef)();
        ...
        _this._handlers = _this.props.isTouch()
            ...
            : [
                [
                    ...
                    _this.props.externalWindow.document,
                ],
                [
                    'mouseup',
    ...
    PinchZoom.prototype._getOffsetTouches = function (event) {
        var externalWindow = this.props.externalWindow;
        var _html = externalWindow.document.documentElement;
        var _body = externalWindow.document.body;
    ...
    PinchZoom.prototype._bindEvents = function () {
        ...
        if (externalWindow.ResizeObserver) {
            this._containerObserver = new externalWindow.ResizeObserver(this._onResize);
    ...
    PinchZoom.prototype._update = function (options) {
        ...
        externalWindow.requestAnimationFrame(function () {
            _this._updatePlaned = false;
            updateFrame();
        });
    };
    ...
    PinchZoom.prototype.render = function () {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement("div", tslib_1.__assign({}, props, { ref: this._containerRef, className: classnames(styles_css_1.styleRoot, props.className) }), (0, react_1.cloneElement)(child, {
