...
var PinchZoom = /** @class */ (function (_super) {
  ...
  function PinchZoom(props) {
    ...
    _this._handlerOnTouchStart = _this._handlerIfEnable(
    ...
    _this._handlerOnTouchMove = _this._handlerIfEnable(
  ...
  PinchZoom.prototype.doZoom = function (zoomFactor, animated) {
    var _this = this;
    var startZoomFactor = this._zoomFactor;
    var rect = this._getContainerRect();
